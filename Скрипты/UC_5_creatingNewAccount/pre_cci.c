# 1 "d:\\temp\\new_script\\uc_5_creatingnewaccount\\\\combined_UC_6_registration_new_users.c"
...
# 1 "d:\\temp\\new_script\\uc_5_creatingnewaccount\\\\combined_UC_6_registration_new_users.c" 2
...
lr_think_time(5);
	...
	lr_end_transaction("Open_sign_up_now",2);
	lr_think_time(5);
	...
	lr_end_transaction("Filling_out_the_form",2);
	lr_think_time(5);
	...
	lr_end_transaction("06_CreatingNewAccount",2);
